...
abstract class AbstractASQueue implements QueueInterface {
    ...
    {
        $this->group = $action_scheduler_queue_group;
        $this->prefix = $prefix;
    }
    ...
    public function add_async( $hook, $args = [] ) {
        try {
            ...
            do_action("{$this->prefix}add_async_exception", $exception->getMessage(), [ 'Action Scheduler Queue' ] );
    ...
    public function schedule_single( $timestamp, $hook, $args = [] ) {
        try {
            ...
            do_action("{$this->prefix}schedule_single_exception", $exception->getMessage(), [ 'Action Scheduler Queue' ] );
    ...
    public function schedule_recurring( $timestamp, $interval_in_seconds, $hook, $args = [] ) {
        ...
        try {
            ...
            do_action("{$this->prefix}as_schedule_recurring_action_exception", $exception->getMessage(), [ 'Action Scheduler Queue' ] );
    ...
    public function is_scheduled( $hook, $args = [] ) {
        ...
        try {
            ...
            do_action("{$this->prefix}as_has_scheduled_action_exception", $exception->getMessage(), [ 'Action Scheduler Queue' ] );
    ...
    public function schedule_cron( $timestamp, $cron_schedule, $hook, $args = [] ) {
        ...
        try {
            ...
            do_action("{$this->prefix}as_schedule_cron_action_exception", $exception->getMessage(), [ 'Action Scheduler Queue' ] );
    ...
    public function cancel( $hook, $args = [] ) {
        try {
            ...
            do_action("{$this->prefix}cancel_exception", $exception->getMessage(), [ 'Action Scheduler Queue' ] );
    ...
    public function cancel_all( $hook, $args = [] ) {
        try {
            ...
            do_action("{$this->prefix}cancel_all_exception", $exception->getMessage(), [ 'Action Scheduler Queue' ] );
        }
    }
    ...
    public function get_next( $hook, $args = null ) {
        try {
            ...
            do_action("{$this->prefix}get_next_exception", $exception->getMessage(), [ 'Action Scheduler Queue' ] );
    ...
    public function search( $args = [], $return_format = OBJECT ) {
        try {
            ...
            do_action("{$this->prefix}search_exception", $exception->getMessage(), [ 'Action Scheduler Queue' ] );
